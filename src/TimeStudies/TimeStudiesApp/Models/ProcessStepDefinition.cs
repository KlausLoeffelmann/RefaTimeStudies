...
/// <summary>
/// Represents a single process step (Ablaufabschnitt) in a time study definition.
/// </summary>
public class ProcessStepDefinition
{
    ...
    /// <summary>
    /// Type of dimension for measurement (Weight, Count, Length, etc.).
    /// </summary>
    ...
    /// <summary>
    /// Marks this step as the default "catch-all" step (Standard-Ablaufabschnitt).
    /// Only one step per definition should have this set to true.
    /// </summary>
