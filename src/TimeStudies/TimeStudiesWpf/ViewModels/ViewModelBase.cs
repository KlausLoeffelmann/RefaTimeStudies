...
public abstract class ViewModelBase : INotifyPropertyChanged
{
    ...
    /// <summary>
    /// Sets the field value and raises PropertyChanged for multiple properties.
    /// </summary>
    protected bool SetProperty<T>(ref T field, T value, params string[] additionalProperties)
    {
        if (EqualityComparer<T>.Default.Equals(field, value))
            return false;
